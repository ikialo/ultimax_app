...
Color colorOne = Color(0xffe83550);
...
class CurveBottom extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(size.width*0.10, size.height*0.70, size.width*0.22, size.height*0.70);
    path.quadraticBezierTo(size.width*0.75, size.height*0.85, size.width, size.height*0.20);
